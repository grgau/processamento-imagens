function main()
    ...
    % Construcao dos arquivos csv com os vetores caracteristicas
    caracteristicas = [vetor_benigno_hsi_dim(:), vetor_benigno_hsi_entro(:), vetor_benigno_hsi_op(:)];    
    xlswrite('vetores_caracteristicas/Imagens I benign.xlsx', caracteristicas);
    
    caracteristicas = [vetor_maligno_hsi_dim(:), vetor_maligno_hsi_entro(:), vetor_maligno_hsi_op(:)];    
    xlswrite('vetores_caracteristicas/Imagens I malign.xlsx', caracteristicas);
    
    caracteristicas = [vetor_benigno_seg_1_dim(:), vetor_benigno_seg_1_entro(:), vetor_benigno_seg_1_op(:)];    
    xlswrite('vetores_caracteristicas/Imagens Seg1 benign.xlsx', caracteristicas);
    
    caracteristicas = [vetor_maligno_seg_1_dim(:), vetor_maligno_seg_1_entro(:), vetor_maligno_seg_1_op(:)];    
    xlswrite('vetores_caracteristicas/Imagens Seg1 malign.xlsx', caracteristicas);
    
    caracteristicas = [vetor_benigno_seg_2_dim(:), vetor_benigno_seg_2_entro(:), vetor_benigno_seg_2_op(:)];    
    xlswrite('vetores_caracteristicas/Imagens Seg2 benign.xlsx', caracteristicas);
    
    caracteristicas = [vetor_maligno_seg_2_dim(:), vetor_maligno_seg_2_entro(:), vetor_maligno_seg_2_op(:)];    
    xlswrite('vetores_caracteristicas/Imagens Seg2 malign.xlsx', caracteristicas);
